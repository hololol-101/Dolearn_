...
<div class="wrap1">
    ...
    <div class="owl-carousel owl-theme">
        ...
        <div class="item">
            <div class="w1">
                <a href="{{ route('manage.lecture.lecture_info', ['idx' => $operatingLecture->idx]) }}" class="a1">
                    <div class="f1">
                        <span class="f1p1">
                ...
                <div class="btns">
                    <a href="javascript:void(0);" class="a2"><span class="a2t1">미해결 질문</span> <span class="a2t2">4</span></a>
                    <a href="javascript:void(0);" class="a2"><span class="a2t1">미채점 시험/과제</span> <span class="a2t2">2</span></a>
                </div>
            </div>
        </div>
        @endforeach
