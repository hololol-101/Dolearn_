    ...
    <div class="menu">
        <div class="w1">
            <div class="mNum">
                ...
                <a href="#vpr1c2" class="m m2"><i class="ic1"></i> <span class="t1 blind">02</span></a>
                <a href="#vpr1c3" class="m m3"><i class="ic1"></i> <span class="t1 blind">03</span></a>
            </div>
...
<script>/*<![CDATA[*/
    $(function(){ // 20201217.
        $('#vpr1').jQmPR1({interval:6000, mTabindex:'-1', effect:'fade', gesture:true});
    });
/*]]>*/</script>
