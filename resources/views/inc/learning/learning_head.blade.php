...
<!-- gn1 -->
<div id="gn1">
	<a href="{{ route('sub.lecture.lecture_detail', ['idx' => $_GET['idx']]) }}" class="a1" title="강좌 정보로 이동"><span class="ic1"></span> <span class="t1">강좌 정보</span></a>
</div>
<!-- /gn1 -->
...
<div id="tnb1">
	...
	<div class="cont"><div class="bg"></div>
		...
		<div class="d1">
            ...
            <li class="m5">
                <a href="javascript:void(0);" title="질문 게시판" onclick="onClickTab('qna', '.m5')"><span class="t1">질문 게시판</span></a>
            </li>
            <li class="m6">
