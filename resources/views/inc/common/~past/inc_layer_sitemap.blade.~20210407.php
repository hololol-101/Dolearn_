	...
	<div class="cont">
		...
		<div class="d1">
            ...
            <li class="m2"><a href="#"><span class="t1">강좌관리</span></a>
                <div class="d2">
                    <ul>
                    <li class="m1"><a href="{{ route('manage.instructor.operation_lecture', ['role' => 'instructor']) }}"><span class="t1">운영 강좌</span></a></li>
                    <li class="m2"><a href="{{ route('manage.instructor.question_list', ['role' => 'instructor']) }}"><span class="t1">질문 리스트</span></a></li>
                    <li class="m3"><a href="{{ route('manage.instructor.review_list', ['role' => 'instructor']) }}"><span class="t1">수강후기 리스트</span></a></li>
                    <li class="m4"><a href="{{ route('manage.instructor.income_info', ['role' => 'instructor']) }}"><span class="t1">수익 내역</span></a></li>
                    </ul>
                </div>
            </li>
            @endif
			...
			<li class="m2"><a href="#"><span class="t1">학습관리</span></a>
				<div class="d2">
					...
					<li class="m3"><a href="{{ route('sub.management.my_question') }}"><span class="t1">내 질문</span></a></li>
					</ul>
				</div>
			</li>
			<li class="m3"><a href="#"><span class="t1">영상보관함</span></a>
				<div class="d2">
					...
					<li class="m3"><a href="{{ route('sub.video.video_playlist') }}"><span class="t1">재생목록</span></a></li>
					</ul>
				</div>
			</li>
			...
			<li class="m5"><a href="#"><span class="t1">계정설정</span></a>
				<div class="d2">
					<ul>
