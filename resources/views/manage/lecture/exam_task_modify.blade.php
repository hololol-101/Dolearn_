	...
	<div class="item mw-radio1">
		...
		<div class="dd">
			<span class="dpib mgr1em">
				<input type="radio" name="★1radio0" id="★1radio0e0" {{-- DB에서 가져와야 함 --}}@if ($_GET['type'] == 'exam') checked="checked" @endif/><label for="★1radio0e0" class="form-static1">시험</label>
			</span>
			<span class="dpib">
				<input type="radio" name="★1radio0" id="★1radio0e1" @if ($_GET['type'] == 'task') checked="checked" @endif/><label for="★1radio0e1" class="form-static1">과제</label>
			</span>
		</div>
	</div>
	<div class="item">
		<div class="dt"><span>과제 내용</span></div>
		<div class="dd">
			<!-- cp1write1 -->
			<div class="cp1write1">
				<div class="editor">
