				...
				<div class="w1item" id="div_bchap">
                    ...
                    @if (isset($bchapterList))
                        ...
                        <div class="item">
                            ...
                            <div class="tg1">
                                <a href="javascript:void(0);"><span class="t1 form-static1" bchap_id="{{ $bchapter->bchap_id }}">{{ $bchapter->bchap_name }}</span></a>
                            </div>
                            <div class="eg1">
				...
				<div class="w1item" id="div_schap">
                    ...
                    @if (isset($schapterList))
                        ...
                        <div class="item">
                            <div class="control move" title="끌어서 놓기로 순서 이동"></div>
                            <div class="tg1">
                                <a href="javascript:void(0);"><span class="t1 form-static1" bchap_id="{{ $schapter->bchap_id }}" schap_id="{{ $schapter->schap_id }}">{{ $schapter->schap_name }}</span></a>
                            </div>
                            <div class="eg1">
                                <button type="button" class="b1 edit"><span class="b1t1">수정</span></button>
                                <button type="button" class="b1 del"><span class="b1t1">삭제</span></button>
                    ...
                    @if ($isFree == 'Y')
                        ...
                        @if (isset($videoInfoList))
                            ...
                            <div class="item">
                                <div class="control move" title="끌어서 놓기로 순서 이동"></div>
                                <div class="tg1">
                                    <a href="javascript:void(0);"><span class="t1 form-static1" bchap_id="{{ $videoInfo->bchap_id }}" schap_id="{{ $videoInfo->schap_id }}" video_id="{{ $videoInfo->uid }}" analysis_yn="{{ $videoInfo->analysis_yn }}" preview_yn="{{ $videoInfo->preview_yn }}">{{ $videoInfo->subject }}</span></a>
                                </div>
                                <div class="eg1">
	...
	$(function(){
        ...
        (function(){
			...
			var _input = ''; // 폼항목 태그
				...
				_input += '		 <a href="javascript:void(0);"><input type="text" value="" placeholder="대단원 제목을 입력하세요." title="대단원 제목" class="w100 type1 text" /></a>';
				_input += '	</div>';
