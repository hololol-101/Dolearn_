...
@if (isset($status))
<form action="{{ route('admin.faq.edit') }}" method="post" id="frm" enctype="multipart/form-data" onsubmit="return sendwrite();">

@else
<form action="{{ route('admin.faq.create') }}" method="post" id="frm" enctype="multipart/form-data" onsubmit="return sendwrite();">
