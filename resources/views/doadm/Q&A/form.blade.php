...
@if(isset($status))
<form action="{{ route('admin.qna.answer_edit') }}" method="post" id="frm" enctype="multipart/form-data" onsubmit="return sendwrite();">
@else
<form action="{{ route('admin.qna.answer') }}" method="post" id="frm" enctype="multipart/form-data" onsubmit="return sendwrite();">
@endif
