...
<div id="body_title">
	...
	<!-- lnb1 -->
	<div id="lnb1">
		<strong class="h1"><a href="#lnb1c" class="toggle slide" title="현재 위치"><span class="t1">수강바구니</span> <i class="ic1"></i></a></strong>
		<!-- lnb1c -->
		<div id="lnb1c">
			<ul>
			<li><a href="{{ route('payment.payment_cart') }}">수강바구니</a></li>
			<li><a href="{{ route('payment.purchase_info') }}">구매정보</a></li>
			</ul>
		</div>
		<!-- /lnb1c -->
	</div>
