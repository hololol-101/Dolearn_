				...
				<div class="w1item" id="div_video">
                    ...
                    @if (isset($videoInfoList))
                        ...
                        <div class="item">
                            <div class="control move" title="끌어서 놓기로 순서 이동"></div>
                            <div class="tg1">
                                <span class="t1 form-static1" bchap_id="{{ $videoInfo->bchap_id }}" schap_id="{{ $videoInfo->schap_id }}" video_id="{{ $videoInfo->uid }}" analysis_yn="{{ $videoInfo->analysis_yn }}" preview_yn="{{ $videoInfo->preview_yn }}">{{ $videoInfo->title }}</span>
                            </div>
                            <div class="eg1">
                                <a @if ($videoInfo->preview_yn == 'Y') href="javascript:void(0);" @endif class="b1 preview tooltip1"><span class="tooltip1c">미리보기 영상</span></a>
                                <button type="button" class="b1 edit"><span class="b1t1">수정</span></button>
                                <button type="button" class="b1 del"><span class="b1t1">삭제</span></button>
                            </div>
                        </div>
...
<div class="cp1tag4">
    ...
    @if (isset($videoTagArr) && count($videoTagArr) > 1)
...
function addUrlToVideoList() {
    ...
    var _video = ''; // 강의 태그
        ...
        _video +=       '<a href="javascript:void(0);" class="b1 preview tooltip1"><span class="tooltip1c">미리보기 영상</span></a>';
