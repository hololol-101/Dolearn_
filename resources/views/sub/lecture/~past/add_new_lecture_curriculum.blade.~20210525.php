				...
				<div class="w1item" id="div_video">
                    ...
                    @if (isset($videoInfoList))
                        ...
                        <div class="item">
                            <div class="control move" title="끌어서 놓기로 순서 이동"></div>
                            <div class="tg1">
                                <a href="javascript:void(0);"><span class="t1 form-static1" bchap_id="{{ $videoInfo->bchap_id }}" schap_id="{{ $videoInfo->schap_id }}" video_id="{{ $videoInfo->uid }}" analysis_yn="{{ $videoInfo->analysis_yn }}" preview_yn="{{ $videoInfo->preview_yn }}">{{ $videoInfo->title }}</span></a>
                            </div>
                            <div class="eg1">
