	...
	<div id="location1">
		<div class="breadcrumb clearfix">
			...
			<span class="cont">
				...
				<i class="sep">|</i>
				<a href="{{ route('sub.management.lecture_note_list') }}" class="a1"><i class="t1">영상 노트</i></a>
			</span>
		</div>
	</div>
	<!-- /location1 -->
...
<div class="cp1flist2">
	<ul class="lst1">
		<li class="li1">
			<div class="w1">
				<div class="w1w1">
					<a href="{{ route('sub.management.lecture_note_detail', ['id' => '']) }}" class="a1">
						<div class="a1w1">
								<div class="f1">
									<span class="f1p1">
				...
				<div class="w1w2">
					<div class="eg1">
						<a href="{{ route('sub.management.lecture_note_detail', ['id' => '']) }}" class="a2">노트 0개</a>
