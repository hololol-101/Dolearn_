...
<div class="cp1form1item1">
	...
	<div class="dd">
		<input type="text" id="★1text0" value="" placeholder="제목을 입력하세요." class="w100 bdct bgct" />
	</div>
</div>
...
<div class="cp1form1item1">
	...
	<div class="dd">
		<textarea id="★1textarea0" rows="5" cols="80" placeholder="문의 내용을 입력하세요." class="w100 bdct bgct"></textarea>
	</div>
</div>
...
<div class="infomenu1">
	<div class="center">
		...
		<a href="javascript:void(0);" class="button secondary wide round  fsB2">취소하기</a>
	</div>
</div>
<!-- /infomenu1 -->
