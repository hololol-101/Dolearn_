<?php $d1n=0;$d2n=0;$d3n=0;$d4n=0;$d5n=0;$d6n=0;
$pageTitle=""; ?>
...
$mAll[2][1][0][0] = "AI 러닝 소개"."|".$sitePath."/html/sub/02_01.php";
...
$mAll[7][2][0][0] = "개인정보취급방침"."|".$sitePath."/html/sub/05_02.php";
$mAll[7][3][0][0] = "이메일무단수집거부"."|".$sitePath."/html/sub/05_03.php";
$mAll[7][4][0][0] = "이용약관"."|".$sitePath."/html/sub/05_04.php";
