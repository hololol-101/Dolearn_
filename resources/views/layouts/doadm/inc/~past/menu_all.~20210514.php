...
$mAll[3][2][0][0] = "FAQ(1:1문의)"."|".$sitePath."/html/sub/03_02.php"."|".$subMain;
	$mAll[3][2][1][0] = "1:1문의(작성)"."|".$sitePath."/html/sub/03_02_01.php";
	$mAll[3][2][2][0] = "1:1문의(상세)"."|".$sitePath."/html/sub/03_02_02.php";
...
$mAll[4][1][0][0] = "내 강의실"."|".$sitePath."/html/sub/04_01.php";
	$mAll[4][1][1][0] = "강의상세"."|".$sitePath."/html/sub/04_01_01.php";
$mAll[4][2][0][0] = "이전 강의실"."|".$sitePath."/html/sub/04_02.php";
	$mAll[4][2][1][0] = "성적확인"."|".$sitePath."/html/sub/04_02_01.php";
...
$mAll[5][3][0][0] = "내결제"."|".$sitePath."/html/sub/05_03.php";
	//$mAll[5][3][1][0] = "결제내역상세보기(레이어팝업)"."|".$sitePath."/html/sub/05_03_)1.php";
...
$mAll[6][2][0][0] = "회원가입"."|".$sitePath."/html/sub/06_02.php";
	$mAll[6][2][1][0] = "학생 회원가입"."|".$sitePath."/html/sub/06_02_01.php";
	$mAll[6][2][2][0] = "학원 회원가입"."|".$sitePath."/html/sub/06_02_01.php";
...
$mAll[7][5][0][0] = "관련사이트"."|".$sitePath."/html/sub/07_05.php";


// 공통메뉴
$mAll[0][0][0][0] = "Home"."|".$sitePath."/"; // HOME
