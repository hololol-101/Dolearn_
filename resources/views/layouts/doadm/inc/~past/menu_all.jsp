...
mAll[1][1][0][0] = "AI 펜덕스 소개"+"|"+sitePath+"/html/sub/01_01.jsp";
...
mAll[6][2][0][0] = "회원가입"+"|"+sitePath+"/html/sub/06_02.jsp";

// 1depth
mAll[7][0][0][0] = "기타안내"+"|"+sitePath+"/html/sub/sitemap.jsp";

mAll[7][1][0][0] = "사이트맵"+"|"+sitePath+"/html/sub/sitemap.jsp";
mAll[7][2][0][0] = "개인정보취급방침"+"|"+sitePath+"/html/sub/05_02.jsp";
mAll[7][3][0][0] = "이메일무단수집거부"+"|"+sitePath+"/html/sub/05_03.jsp";
mAll[7][4][0][0] = "이용약관"+"|"+sitePath+"/html/sub/05_04.jsp";
