 ...
 * @Description : IA(1~4Depth) 메뉴 배열(이름,링크,속성) 정의. viewType, siteName, sitePath, title, keywords, description, locationLink, titleImgAlt, titleImg, bodyClass, ..
 * @Modification Information
 * <pre>
 * 수정일 | 수정자 | 수정내용
 * 2020.11.10 | 문영신 | 최초 등록
 * 2020.11.13 | 문영신 | 요구반영. 결함개선. 고도화.
 * </pre>
...
String siteName = "인제대학교 해운대 백병원 임상시험센터";
...
// 1depth
mAll[1][0][0][0] = "AI 펜덕스 란"+"|"+sitePath+"/html/sub/01_01.jsp";

mAll[1][1][0][0] = "AI 펜덕스 란"+"|"+sitePath+"/html/sub/01_01.jsp";

// 1depth
mAll[2][0][0][0] = "AI 러닝소개"+"|"+sitePath+"/html/sub/02_01.jsp";

mAll[2][1][0][0] = "Phonics"+"|"+sitePath+"/html/sub/02_01.jsp";
mAll[2][2][0][0] = "Elem"+"|"+sitePath+"/html/sub/02_02.jsp";
mAll[2][3][0][0] = "Bridge"+"|"+sitePath+"/html/sub/02_03.jsp";
mAll[2][4][0][0] = "Inter"+"|"+sitePath+"/html/sub/02_04.jsp";
mAll[2][5][0][0] = "Upper"+"|"+sitePath+"/html/sub/02_05.jsp";
mAll[2][6][0][0] = "Text 7"+"|"+sitePath+"/html/sub/02_06.jsp";
mAll[2][7][0][0] = "Text 8"+"|"+sitePath+"/html/sub/02_07.jsp";

// 1depth
mAll[3][0][0][0] = "커뮤니티"+"|"+sitePath+"/html/sub/03_01.jsp";

mAll[3][1][0][0] = "원장님 후기"+"|"+sitePath+"/html/sub/03_01.jsp";
mAll[3][2][0][0] = "공지사항"+"|"+sitePath+"/html/sub/03_02.jsp";
mAll[3][3][0][0] = "FAQ"+"|"+sitePath+"/html/sub/03_03.jsp";
mAll[3][4][0][0] = "신규 상담신청"+"|"+sitePath+"/html/sub/03_04.jsp";
...
mAll[4][4][0][0] = "회원정보수정"+"|"+sitePath+"/html/sub/04_04.jsp";

// 1depth
mAll[5][0][0][0] = "기타안내"+"|"+sitePath+"/html/sub/sitemap.jsp";

mAll[5][1][0][0] = "사이트맵"+"|"+sitePath+"/html/sub/sitemap.jsp";
mAll[5][2][0][0] = "개인정보취급방침"+"|"+sitePath+"/html/sub/05_02.jsp"+"|"+newWin;
mAll[5][3][0][0] = "이메일무단수집거부"+"|"+sitePath+"/html/sub/05_03.jsp"+"|"+newWin;
mAll[5][4][0][0] = "이용약관"+"|"+sitePath+"/html/sub/05_04.jsp"+"|"+newWin;
